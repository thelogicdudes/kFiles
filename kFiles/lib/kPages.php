...
class kPages
{
	...
	function __construct()
	{
		...
		{
			case "home":
				$this->keywords = "Advertise, orlando, site design, websites, modernize";
				$this->title = "LogicDudes - Orlando, FL - Information Managers";
				$this->description = "Don't let the future turn you into the past! Contact us today to ensure your business is designed for the modern world!";
				$this->headers();
				$this->home();
				break;
			case "about":
				...
				$thing = ucfirst($thing);
				$this->title = "$thing - LogicDudes - Orlando, FL - Information Managers";
				$this->description = "We are Internet enthuiasts.";
				$this->headers();
				$this->about();
				break;
			case "404":
				$this->keywords = "Advertise, orlando, site design, websites, modernize";
				$this->title = "404 - LogicDudes - Orlando, FL - Information Managers";
				$this->description = "LogicDudes - Page Not Found";
				$this->headers();
				$this->k404();
				break;
			case "403":
				$this->keywords = "Advertise, orlando, site design, websites, modernize";
				$this->title = "403 - LogicDudes - Orlando, FL - Information Managers";
				$this->description = "LogicDudes - You DO NOT Have Permission";
				$this->headers();
				$this->k403();
				break;
			default:
		...
		?>
			...
			<html>
				<head>
					...
					<meta name="date" content="2013-03-01T11:40:46-0500" >
